  ...
  return (
    <div className="bg-gray-950 text-white">
      ...
      <section className="text-center py-20 px-4">
        ...
        <p className="text-lg mt-4 max-w-3xl mx-auto text-gray-400">
      ...
      <section className="py-20 px-4 bg-gray-900">
        <div className="container mx-auto">
          ...
          <p className="text-center text-lg max-w-2xl mx-auto text-gray-400 mb-12">
            A fully managed, AI-powered sales development rep — without the
            salary.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gray-800 p-6 rounded-lg">
              <h3 className="text-xl font-bold">Multi-Channel AI Engagement</h3>
              <p className="mt-2 text-gray-400">
                We engage leads on every channel — so you’re first to respond.
              </p>
            </div>
            <div className="bg-gray-800 p-6 rounded-lg">
              <h3 className="text-xl font-bold">AI Lead Qualification</h3>
              <p className="mt-2 text-gray-400">
            ...
            <div className="bg-gray-800 p-6 rounded-lg">
              <h3 className="text-xl font-bold">Lead Scoring & Routing</h3>
              <p className="mt-2 text-gray-400">
            ...
            <div className="bg-gray-800 p-6 rounded-lg">
              <h3 className="text-xl font-bold">Reporting & Optimization</h3>
              <p className="mt-2 text-gray-400">
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
          <div>
            <h3 className="text-2xl font-bold">Stay Relevant</h3>
          ...
          <div>
            <h3 className="text-2xl font-bold">Count on us</h3>
            <p className="mt-4 text-gray-400">
          ...
          <div>
            <h3 className="text-2xl font-bold">Try, try again</h3>
            <p className="mt-4 text-gray-400">
